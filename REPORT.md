...
| [sources/02-dco-signoff-and-authorship.md](sources/02-dco-signoff-and-authorship.md) | The [DCO](GLOSSARY.md#dco) text, what `Signed-off-by:` legally certifies, the kernel's `Co-developed-by:`+sign-off rule, and why an AI cannot certify. |
